...
public class AuthController {
    ...
    public ResponseEntity<?> signup(@RequestBody SignupRequest request){
        ...
        user.setPassword(passwordEncoder.encode(request.getPassword()));// plain -> hashed password
    ...
    @PostMapping("/login")
    //<?> is a wildcard generic in Java that allows a method to return a ResponseEntity of any type.
    public ResponseEntity<?> login(@RequestBody LoginRequest request) {
        ...
        // Generate token with claims (claims -> extra info that we add )
        //Creates token with email, role, id
